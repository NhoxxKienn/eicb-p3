...
public class Profiler {
	...
	public int[] regReadCount = new int[Register.count];
	public int[] regWriteCount = new int[Register.count];
	public int[] opcodeExecCount = new int[Opcode.count];
	public int[] primitiveExecCount = new int[Primitive.count];
